...
const DropdownUser = ({userName}: {userName: string}) => {
    ...
    return (
        <div className="relative">
            ...
            <div 
                ref={dropdown} 
                className={cn('absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark dark:text-white', {
                    hidden: !dropdownOpen,
                  }
                  )}
            >
